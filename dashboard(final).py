...
beta = st.sidebar.slider("Weight for Visit Count (β)", min_value=0.0, max_value=2.0, value=1.0, step=0.1)
gamma = st.sidebar.slider("Weight for Dwell Time (γ)", min_value=0.0, max_value=2.0, value=1.0, step=0.1)
